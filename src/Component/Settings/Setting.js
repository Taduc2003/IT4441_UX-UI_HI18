          ...
          <div className="section">
            ...
            <div className="content">
              <div className="row">
                ...
                <label>
                  <input type="radio" name="date-format" /> {texts.dateFormat2}
                </label>
              </div>
              <div className="row">
                <p>{texts.timeFormat}</p>
                <label>
                  <input type="radio" name="time-format" defaultChecked />{" "}
                  {texts.timeFormat1}
                </label>
                <label>
                  <input type="radio" name="time-format" /> {texts.timeFormat2}
                </label>
              </div>
              <div className="row">
                <p>{texts.numberFormat}</p>
                <label>
                  <input type="radio" name="number-format" defaultChecked />{" "}
                  {texts.numberFormat1}
                </label>
                <label>
                  <input type="radio" name="number-format" />{" "}
                  {texts.numberFormat2}
                </label>
              </div>
            </div>
